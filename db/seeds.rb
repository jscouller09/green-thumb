...
generate_model_from_csv(User, 'users.csv')
generate_model_from_csv(WeatherStation, 'export_weather_stations.csv')
generate_model_from_csv(Measurement, 'export_measurements.csv')
generate_model_from_csv(ClimateZone, 'export_climate_zones.csv')
generate_model_from_csv(Garden, 'export_gardens.csv')
generate_model_from_csv(Plot, 'export_plots.csv')
generate_model_from_csv(PlantType, 'export_plant_types.csv')
generate_model_from_csv(Plant, 'export_plants.csv')
generate_model_from_csv(Task, 'export_tasks.csv')
generate_model_from_csv(Watering, 'export_waterings.csv')
generate_model_from_csv(WeatherAlert, 'export_weather_alerts.csv')
